...
class Application(Tk):
    ...
    def create_continfo(self):
        ...
        self.count_text = Text(countinfofram, width=20, height=5, bg='white', font=("楷体", 14, "bold"))
        self.count_text.pack(side=LEFT, fill=BOTH, expand=YES, padx=5, pady=2)
    ...
    def update_content_text(self, event=None):
        ...
        self.count_text.insert(END, str)
